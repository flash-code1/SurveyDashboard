...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Anchorb-needle Data Virtualization">
    <meta name="keywords" content="Survey, Managment, Application, Software">
    <meta name="author" content="pixelstrap">
    <link rel="icon" href="assets/images/" type="image/x-icon">
    <link rel="shortcut icon" href="assets/images/" type="image/x-icon">
    <title>Anchorb-needle</title>
    <!-- Google font-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="container-fluid p-0 m-0">
        <div class="comingsoon comingsoon-bgimg">
          <div class="comingsoon-inner text-center"><img src="assets/images/other-images/" alt="">
            <h5>Anchorb-needle Survey Dashboard</h5>
